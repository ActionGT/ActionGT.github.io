...
// Div for Home with buttons text and image
<div
id="home"
style={{
  backgroundImage: "linear-gradient(to right,white 45%, #48AFDE 75%)",
  minHeight: "500px",
  maxHeight: "1200px",
  height: "100%",
  width: "100%",
  ...
  <div className="grid grid-cols-12">
    ...
    <div className="bg-white flex flex-col justify-center col-span-12 md:col-span-5 md:bg-transparent">
      <div className="container m-auto">
        <div className="lg:pl-24 sm:pl-10 pl-0 py-20 md:py-0 md:text-start text-center">
          ...
          >
            Full Stack Developer, Music Producer, Entrepreneur
          </h2>
          <a
            href="/#portfolio"
    ...
    <div className="container m-auto">
      <div className="md:col-span-7 col-span-12 md:pt-[130px] pt-[50px] md:bg-transparent bg-[#d9eef7]">
            <div
  ref={sceneRef}
  className="md:col-span-7 col-span-12 md:pt-[130px] pt-[50px] md:bg-transparent bg-[#d9eef7]">
</div>
      </div>
    </div>
  </div>
