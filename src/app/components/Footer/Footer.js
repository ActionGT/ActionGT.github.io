...
export default function Footer() {
  ...
  return (
    <div id="footer" className="mt-[1px]  ">
      ...
      <footer className="bg-[#2c3e50] h-32 lg:h-[190px]">
        <div className=" mx-auto  pt-6 max-w-screen-xl space-y-8 px-4 py-3  lg:space-y-16 lg:px-8   ">
          ...
          <div className="h-[100px]  xl:max-w-6xl 2xl:max-w-7xl px-10 md:px-20 xl:px-44 mx-auto lg:h-[150px] sm:py-10 overflow-hidden">
